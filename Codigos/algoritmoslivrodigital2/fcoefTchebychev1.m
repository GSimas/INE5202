function c=fcoefTchebychev1(n,a,b)
...
%de T3=(4t^3-3t) em diante poderemos usar a recorrencia p/ i=3:n a partir dos dois ultimos polinomios:
%T(n+1)=2*x*T(n  )-T(n-1)
%T(i  )=2*t*T(i-1)-T(i-2)
for i=3:n
  soma=0;
